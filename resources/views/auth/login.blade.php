        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div class="flex items-center">
                <label for="remember_me" class="flex cursor-pointer items-center">
                    <x-checkbox id="remember_me" name="remember" class="rounded border-neutral-300 text-[#106b38] focus:ring-[#106b38]" />
            ...
            <div class="flex flex-col gap-3 border-t border-neutral-100 pt-5 text-center text-sm sm:flex-row sm:justify-between sm:text-left">
                @if (Route::has('password.request'))
                    <a
                        class="font-medium text-[#106b38] transition hover:text-[#e85e26] focus:outline-none focus-visible:underline"
