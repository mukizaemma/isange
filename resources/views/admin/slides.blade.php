                                    ...
                                    <div class="modal-body">
                                        <form class="form" action="{{ route('saveSlide') }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-lg-6 col-sm-12">
                                                        <label for="slide-heading">Header</label>
                                                        <input type="text" id="slide-heading" class="form-control"
                                                            placeholder="e.g. Eco Resort Near Volcanoes National Park" name="heading">
                                                    </div>
                                                    <div class="col-lg-6 col-sm-12">
                                                        <label for="slide-caption">Caption</label>
                                                        <input type="text" id="slide-caption" class="form-control"
                                                            placeholder="e.g. Comfort. Nature. Purpose." name="subheading">
                                                    </div>
                                                </div>
                                            </div>
