                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    ...
                                    <form action="{{ route('searchBookings') }}" method="GET" class="form-inline">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-sm-12" >
                                                <button type="submit" class="btn btn-primary text-black mt-4">Search</button>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        {{-- <button class="btn btn-primary float-right" data-bs-toggle="modal" data-bs-target="#myModal"><i
                                            class="fa fa-plus"></i> Add New Booking</button> --}}
                                    </div>
                            </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title">Making a Reservation for a client</h4>
