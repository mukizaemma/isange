            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form class="form" action="{{ url('updateNewsl',$post->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div  class="row mt-3">
                                        <div class="col-lg-6 col-sm-12">
                                            <label for="image" class="form-label">Photo de l'actualite<br> <span style="color: red">(Cette image doit être redimensionnée à 500X800
                                                pixels)</span></label>
                                            <img src="{{ asset('storage/images/newsletters/' . $post->image) }}" alt="" width="120px">
                                        </div>
                                        <div class="col-lg-6 col-sm-12">
