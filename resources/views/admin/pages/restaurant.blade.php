                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('restoImages', ['pid' =>$data->id])}}" class="btn btn-secondary" onclick="return !window.open(this.href, '', 'top=50 left=100 width=1100, height=700')">Add Gallery to Restaurant Page</a>
                            ...
                            <!-- ./card-header -->
                            <div class="card-body">
                                <h1>Restaurant Page Setting</h1>
                                <form class="form" action="{{ route('saveRestaurant', $data->id) }}" method="POST"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea id="restaurantDescription" rows="5" class="form-control" name="description">{!! $data->description !!}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label for="summernote" class="form-label">Detailed Description</label>
                                                <textarea id="restaurantDetails" rows="5" class="form-control" name="details">{!! $data->details !!}</textarea>
                                            </div>
                                        </div>
