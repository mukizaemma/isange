                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <button class="btn btn-primary float-right" data-bs-toggle="modal" data-bs-target="#myModal"><i
                                    class="fa fa-plus"></i> Add New Service</button>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach ($services as $rs)
                                        <tr>
                                            <td>{{ $rs->title }}</td>
                                            <td><img src="{{ asset('storage/images/services/' . $rs->image) }}" alt="" width="150px"></td>
                                            <td>
                                                <a href="{{route('serviceImages', ['pid' =>$rs->id])}}" onclick="return !window.open(this.href, '', 'top=50 left=100 width=1100, height=700')">
                                            ...
                                            <td>
                                                <div class="btn-btn-group ">
                                                    <a type="button" href="{{ route('editService', $rs->id) }}" class="btn btn-primary text-black">Edit</a>
                                                    <a type="button" href="{{ route('destroyService', $rs->id) }}"class="btn btn-danger text-black"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form" action="{{ route('saveService') }}" method="POST"
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-lg-8 col-sm-12">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                        id="title" placeholder="Service Title" required="">
                                                </div>
                                            </div>
