                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach ($posts as $rs)
                                        <tr>
                                            <td>{{ $rs->title_fr }}</td>
                                            <td><img src="{{ asset('storage/images/newsletters/' . $rs->image) }}" alt="" width="150px"></td>
                                            {{-- <td>
                                            ...
                                            <td>
                                                <div class="btn-btn-group ">
                                                    <a type="button" href="{{ route('editNewsl', $rs->id) }}" class="btn btn-primary text-black">Modifier</a>
                                                    <a type="button" href="{{ route('destroyNewsl', $rs->id) }}"class="btn btn-danger text-black"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form" action="{{ route('saveNewsl') }}" method="POST"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <textarea id="postDescription" rows="5" class="form-control" name="description_fr"></textarea>
                                                </div>
                                            </div>

                                            <div class="row">
                                                <div class="col-lg-6 col-sm-12">
                                                    <label for="image" class="form-label">Image de couverture<br> <span
