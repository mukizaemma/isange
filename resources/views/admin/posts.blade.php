                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach ($posts as $rs)
                                        <tr>
                                            <td>{{ $rs->title_fr }}</td>
                                            <td><img src="{{ asset('storage/images/posts/' . $rs->image) }}" alt="" width="150px"></td>
                                            {{-- <td>
                                            ...
                                            <td>
                                                <div class="btn-btn-group ">
                                                    <a type="button" href="{{ route('editPost', $rs->id) }}" class="btn btn-primary text-black">Modifier</a>
                                                    <a type="button" href="{{ route('destroyPost', $rs->id) }}"class="btn btn-danger text-black"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form" action="{{ route('savePost') }}" method="POST"
